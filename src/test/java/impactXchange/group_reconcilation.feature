...
Feature: Group Reconcilation
  @testing_add_movie @Reconcile @Group_reconcile
    ...
    Then  Add all details about movies and click on save. "Saturday, October 05, 2019","U" , "Animation ","English","3D","Aamir Khan Productions Pvt. Ltd.",150,"George Miller"Junkie XL,"Tom Hardy,"Charlize Theron,Nicholas Hoult,Hugh Keays-Byrne,Rosie Huntington-Whiteley,Riley Keough,Zoë Kravitz,Abbey Lee,Courtney Eaton".
